<h1 align="center"> 🚀 Get Mouse | Vanilla </h1>

## ✍️ Descrição
Exemplificação de aplicação de mouse move usando vanilla ou Javascript puro
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/get-mouse-vanilla/.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/LYMLmde) 
